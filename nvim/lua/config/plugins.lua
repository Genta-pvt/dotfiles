...
return {
  ...
  -- https://github.com/stevearc/oil.nvim
  {
    ...
    config = function()
      ...
      local detail = false, -- ファイルの詳細情報表示で使う
      require("oil").setup({
        -- ゴミ箱の使用
        ...
        -- ファイルの詳細情報を表示するキーマップを追加 (https://github.com/stevearc/oil.nvim/blob/master/doc/recipes.md#toggle-file-detail-view)
        keymaps = {
          ["gd"] = {
